...
Revision ID: 0e90c7f43fc5
Revises: 
Create Date: 2022-10-30 12:30:20.866454
...
def upgrade():
    ...
    sa.Column('razonSocial', sa.String(length=20), nullable=False),
    sa.Column('email', sa.String(length=50), nullable=True),
    sa.Column('direccion', sa.String(length=255), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('razonSocial')
    )
